            ...
            >
              ...
              {!isFinalized && (
                <div className="absolute inset-0 flex items-center justify-center p-10 pointer-events-none opacity-20 overflow-hidden z-0">
                  <p className="flex items-center justify-center text-9xl font-black text-gray-400 -rotate-45 whitespace-nowrap select-none border-8 border-gray-400 p-10 rounded-[3rem] leading-none">BROUILLON</p>
                </div>
              )}
              {isFinalized && data.type === DocumentType.INVOICE && amountPaid < subtotal && (
                <div className="absolute inset-0 flex items-center justify-center p-10 pointer-events-none opacity-20 overflow-hidden z-0">
                  <p className="flex items-center justify-center text-9xl font-black text-red-500 -rotate-45 whitespace-nowrap select-none border-8 border-red-500 p-10 rounded-[3rem] leading-none">IMPAYÉ</p>
                </div>
              )}
              {isFinalized && data.type === DocumentType.INVOICE && amountPaid >= subtotal && subtotal > 0 && (
                <div className="absolute inset-0 flex items-center justify-center p-10 pointer-events-none opacity-20 overflow-hidden z-0">
                  <p className="flex items-center justify-center text-9xl font-black text-green-600 -rotate-45 whitespace-nowrap select-none border-8 border-green-600 p-10 rounded-[3rem] leading-none">PAYÉ</p>
                </div>
              )}
        ...
        {pages.map((pageItems, index) => {
          ...
          return (
            ...
            >
              ...
              {isFinalized && data.type === DocumentType.INVOICE && amountPaid >= subtotal && subtotal > 0 && (
                <div className="absolute inset-0 flex items-center justify-center p-10 pointer-events-none opacity-20 overflow-hidden z-0">
                  <p className="flex items-center justify-center text-9xl font-black text-emerald-600 -rotate-45 whitespace-nowrap select-none border-8 border-emerald-600 p-10 rounded-[3rem] leading-none">PAYÉ</p>
                </div>
              )}
            ...
            <div key={index} className="bg-white p-12 w-full max-w-[850px] mx-auto shadow-xl relative min-h-[29.6cm] flex flex-col font-serif text-gray-900 print:shadow-none print:m-0 print:border-0 print:break-after-page" style={{ fontFamily: 'Georgia, "Times New Roman", Times, serif', pageBreakAfter: isLastPage ? 'auto' : 'always' }}>
              ...
              {!isFinalized && (
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-10 z-0">
                  <p className="flex items-center justify-center text-[120px] font-bold text-gray-400 -rotate-45 whitespace-nowrap select-none border-[12px] border-gray-400 p-12 rounded-[3rem] leading-none">BROUILLON</p>
                </div>
              )}
              {isFinalized && data.type === DocumentType.INVOICE && amountPaid < subtotal && (
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-10 z-0">
                  <p className="flex items-center justify-center text-[120px] font-bold text-red-500 -rotate-45 whitespace-nowrap select-none border-[12px] border-red-500 p-12 rounded-[3rem] leading-none">IMPAYÉ</p>
                </div>
              )}
              {isFinalized && data.type === DocumentType.INVOICE && amountPaid >= subtotal && subtotal > 0 && (
                <div className="absolute inset-0 flex items-center justify-center pointer-events-none opacity-10 z-0">
                  <p className="flex items-center justify-center text-[120px] font-bold text-green-600 -rotate-45 whitespace-nowrap select-none border-[12px] border-green-600 p-12 rounded-[3rem] leading-none">PAYÉ</p>
                </div>
              )}
